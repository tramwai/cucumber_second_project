Feature: SmartBear Functions Validation
  ...
  Scenario: Validate adding new order
    ...
    And user enters all address information
      |John Doe|2860 S Des Plaines River Rd|Des Plaines|IL|60016|
    ...
    And validate all information entered displayed correct with the order
      | |John Doe|FamilyAlbum|2|02/28/2023|2860 S Des Plaines River Rd|Des Plaines|IL|60016|Visa|123456789012345|01/35|
